// This JS function set is part of a tutorial example. See comment block at the end of this code file
/**
 * Where everything starts
 */
function loadTutorialExampleView() {
    tutorialExampleView.register_drag_drop();
    tutorialExampleView.clear_high_dimensional_input('divGroupByVariable');
    tutorialExampleView.clear_high_dimensional_input('divDependentVariable');
    tutorialExampleView.toggle_binning();
}
 ...
 * @constructor
 */
var TutorialExampleView = function () {
 ...
 * @type {RmodulesView}
 */
TutorialExampleView.prototype = new RmodulesView();

/**
 * Correct pointer
 * @type {TutorialExampleView}
 */
TutorialExampleView.prototype.constructor = TutorialExampleView;
 ...
 * @returns {*}
 */
TutorialExampleView.prototype.get_form_params = function (form) {
...
TutorialExampleView.prototype.load_high_dimensional_parameters = function (formParams) {
 ...
 */
TutorialExampleView.prototype.toggle_binning = function () {
...
TutorialExampleView.prototype.update_manual_binning = function () {
...
TutorialExampleView.prototype.manage_bins = function (newNumberOfBins) {
...
TutorialExampleView.prototype.load_binning_parameters = function (formParams) {
 ...
 * @param form
 */
TutorialExampleView.prototype.submit_job = function (form) {
...
var tutorialExampleView = new TutorialExampleView();
